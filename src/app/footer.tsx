        ...
        <footer className="body-font">
            <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                ...
                <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    <a href="/" className="lg:w-1/4 md:w-1/2 w-full font-medium px-4 hover:translate-y-[-0.25dvh] duration-100">
                        <p className="title-font font-medium tracking-widest text-sm mb-3">ホーム</p>
                    </a>
                    <a href="/guarantee" className="lg:w-1/4 md:w-1/2 w-full font-medium px-4 hover:translate-y-[-0.25dvh] duration-100">
                        <p className="title-font font-medium tracking-widest text-sm mb-3">MiX保証</p>
                    </a>
                    <a href="/loan" className="lg:w-1/4 md:w-1/2 w-full font-medium px-4 hover:translate-y-[-0.25dvh] duration-100">
                        <p className="title-font font-medium tracking-widest text-sm mb-3">自社ローン</p>
                    </a>
                    <a href="/coating" className="lg:w-1/4 md:w-1/2 w-full font-medium px-4 hover:translate-y-[-0.25dvh] duration-100">
                        <p className="title-font font-medium tracking-widest text-sm mb-3">コーティング</p>
                    </a>
                    <a href="/news" className="lg:w-1/4 md:w-1/2 w-full font-medium px-4 hover:translate-y-[-0.25dvh] duration-100">
